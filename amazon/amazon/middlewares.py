...
class AmazonSpiderMiddleware:
    """
    Not all methods need to be defined. If a method is not defined, scrapy acts as if the spider middleware does not
    modify the passed objects.
    """
    ...
    def process_spider_input(self, response, spider):
        ...
        :param response:
        :param spider:
        :return: Should return None or raise an exception.
        """
        return None
    ...
    def process_spider_output(self, response, result, spider):
        ...
        :param result:
        :param spider:
        :return: Must return an iterable of Request, dict or Item objects.
        """
        for i in result:
            yield i
    ...
    def process_spider_exception(self, response, exception, spider):
        ...
        :param exception:
        :param spider:
        :return: Should return either None or an iterable of Request, dict or Item objects.
        """
        pass
...
class AmazonDownloaderMiddleware:
    """
    Not all methods need to be defined. If a method is not defined, scrapy acts as if the downloader middleware does not
    modify the passed objects.
    """
